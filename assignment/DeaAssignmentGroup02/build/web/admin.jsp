...
<head>
    ...
    <title> Administrator Login | Smart Hub </title>
    ...
    <meta property="og:title" content="Gallery | Coconut Coir Sri Lanka " />
    ...
    <meta name="msapplication-TileImage" content="img/favicons/mstile-144x144.html">
...
<body>
 ...
 <div id="main-container">
       ...
       <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-2 col-lg-2">
                    <a id="logo" class="pull-left img-responsive" href="index.html"><img src="img/logos/nsbm-logo.png" alt="NSBM Logo" /></a>
                </div>
                    ...
                    <nav id="main-menu" class="pull-right">
                        ...
                        <ul class="nav-list">
                            ...
                            <li class="">
                                ...
                                <ul>
                                    <li class="">
                                        <a href="about-us.html"><span>About NSBM</span></a>
                                    </li>
                                    <li class="">
                                    ...
                                    <li class="">
                                        <a href="green-university.html"><span>Green University</span></a>
                                    </li>
                                    <li class="">
                                        <a href="affiliated-universities.html"><span>Affiliated Universities</span></a>
                                    </li>
                                    <li class="">
                                        <a href="well-wishes.html"><span>Well Wishes</span></a>
                                    </li>
                                </ul>
                            </li>

                            <li class="">
                                <a href="ideahub.html">Idea Hub</a>
        ...
        <div class="navbar navbar-default" role="navigation">
            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="http://www.coconutcoirsrilanka.com">Student Registration | Smart Hub</a>
                ...
                <div class="collapse navbar-collapse">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="">
                            <a href="indexhttp://www.coconutcoirsrilanka.com">Home</a>
                        </li>
                        ...
                        <li class="dropdown ">
                            <a href="products" class="active" class="dropdown-toggle" data-toggle="dropdown" >Public Posts <b class="caret"></b></a>
       ...
       <div class="pull-right">
            ...
            <a class="sub-nav-item" href="login/index.html"><span class="glyphicon glyphicon-book"></span> Login >></a>
     ...
     <div class="content-wrapper">
        ...
        <div id="hero-cover-contact" class="bg-cover hero-cover-sm pos-rel">
            ...
            <div class="container center-x-y hero-meta">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                      <h1 class="h2 color-white title">Login Now</h1>
                      <p class="color-white">You are about to login as a student ...</p>
                      <p class="no-mb">General Inquiries: <a class="color-white" href="mailto:hello@smarthub.lk">hello@smarthub.lk</a></p>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 left-aside">
                        ...
                        <form method="POST" action="" accept-charset="UTF-8"><input name="_token" type="hidden" value="">
                            ...
                            <p class="h4 mb-lg">Administrator Access:</p>
              ...
              <hr>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <input type="password" class="form-control" required="required" name="pword">
                                </div>

                            </div>
                           
                       <!--     <div class="form-group fg-textarea">
                                <label>Yourself(Max: 5000) <span class="req">&#42;</span></label>
                                <textarea class="form-control" placeholder="Say your requirement in detailed..." rows="10" style="height: 173px;" required name="message" cols="50" maxlength="5000"></textarea>
                            </div> -->
                            ...
                            <input class="btn btn-lg btn-block btn-green" type="submit" value="LOGIN">
...
<div id="modal_qualifications" class="modal fade" role="dialog" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <div class="row mb-md">
                    ...
                    <div class="col-xs-12">
                        ...
                        <h4 class="mb-lg">Conditions:</h4>

                        
                            <p><strong>Before Submitting form </strong></p>

                            <ul>
                            <li>I've read all the guidelines of this virtual environment.</li>
								<li>My company is registered as a business in Sri Lanka.</li>
                            <li>I'm not spamming the system.</li>
                            <li>Agree to all other conditions, applied by the system.</li>
                                                            </ul>
