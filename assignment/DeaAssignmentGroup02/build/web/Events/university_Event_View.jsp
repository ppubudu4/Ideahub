...
<head>
    ...
    <title>University Dashboard | Smart Hub of NSBM Green University Town </title>
...
<center>
              <form action="university_Event_View.jsp" >
            
            <table>
            
                <tr><td>Date of the event</td><td><input type="date" name="date" value="" /></td></tr>
                <tr><td>Events</td><td><textarea rows="4" cols="50" name="events" value="" ></textarea></td></tr>
  ...
  <%
              ...
              String com_name1=(String)session.getAttribute("com_name");
          ...
          while(rs.next()){
              ...
              <tr>
                        ...
                        <td><a href='Eventcomment.jsp?id=<%= rs.getString(2)%>'>Add Comment</a></td>
